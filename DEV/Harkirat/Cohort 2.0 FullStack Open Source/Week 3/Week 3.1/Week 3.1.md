...
![Untitled 1 3.png](../../../../Images/Untitled%201%203.png)
...
Let's explore two approaches to input validation: the naive way with multiple  
`if-else` statements and using the `**zod**` library for schema validation.
